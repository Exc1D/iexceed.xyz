async function loadPost() {
  ...
  try {
    ...
    document.getElementById("post-date").textContent = new Date(postMeta.date).toLocaleDateString();
    ...
    document.getElementById("post-content").textContent = "This post may have been removed or is temporarily unavailable.";
